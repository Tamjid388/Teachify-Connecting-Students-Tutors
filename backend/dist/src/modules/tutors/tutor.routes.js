...
router.post("/", authMiddleware("TUTOR", "ADMIN"), tutorController.createTutorProfile);
...
router.put("/update", authMiddleware("TUTOR", "ADMIN"), tutorController.updateTutor);
router.put("/update/availability", authMiddleware("TUTOR"), tutorController.updateAvailability);
//add slots

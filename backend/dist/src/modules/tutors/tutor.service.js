...
const createTutor = async (body, user) => {
...
const updateTutor = async (body, user) => {
...
const updateAvailability = async (slot, user) => {
...
const createSlots = async (slots, userId) => {

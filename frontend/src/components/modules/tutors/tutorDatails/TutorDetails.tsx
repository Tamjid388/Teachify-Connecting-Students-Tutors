    ...
    <div className="min-h-screen ">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <div
          ...
          style={{ backgroundColor: "var(--color-custom-accent)" }}
        ></div>
      </div>
          ...
          <div className="relative px-8 pb-8">
            <div className="flex flex-col lg:flex-row gap-8 -mt-20">
              ...
              <div className="relative flex-shrink-0">
                ...
                {data.is_verified && (
                  <div
                    className="absolute -bottom-2 -right-2 text-white rounded-full p-2 shadow-lg"
                    style={{ backgroundColor: "var(--color-custom-accent)" }}
                  >
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {data.is_verified && (
                        <span
                          ...
                          style={{
                            backgroundColor: "var(--color-custom-accent)",
                          }}
                        >
                          Verified
                        </span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{ color: "var(--color-custom-primary)" }}
                      >
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center"
                        style={{ color: "var(--color-custom-secondary)" }}
                      >
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 col-span-2 md:col-span-1">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center"
                        style={{ color: "var(--color-custom-accent)" }}
                      >
